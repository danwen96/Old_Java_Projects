...
import ch.makery.address.model.ProductListWrapper;
import ch.makery.address.view.ProductEditDialogController;
import ch.makery.address.view.ProductOverviewController;
...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        productData.add(new Product("Chleb", 5,Product.ProductType.BAKEDGOODS));
        productData.add(new Product("Bu³ka", 6,Product.ProductType.BAKEDGOODS));
        productData.add(new Product("Marchew", 3,Product.ProductType.VEGETABLES));
        productData.add(new Product("Jab³ko", 9,Product.ProductType.FRUITS));
     ...
     * is returned.
     * 
     * @param product the person object to be edited
    ...
    public void setProductFilePath(File file) {
        ...
        if (file != null) {
            ...
            primaryStage.setTitle("Products - " + file.getName());
        } else {
